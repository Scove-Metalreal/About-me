...
//         // Example:  Toggle a class to show/hide more details
//         const content = this.querySelector('.timeline-content');
//         content.classList.toggle('expanded'); // You'd need to define .expanded in your CSS
//         // Add additional logic here if needed
//       });

//       //Hide the tool tip when not hovering
